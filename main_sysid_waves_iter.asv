...
params.getData = 'larm_192val_16sid_sc09_191000pts_1del_Ts1.mat';            % (name of the data file)
...
params.systemName          = ['waves_192val_larm_sc09_191000pts_1del_Ts1_' , basisID , num2str(maxDegree) ];  % name of current system
